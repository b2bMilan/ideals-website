...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy" style={{ padding: '20px', lineHeight: '1.6' }}>
      <h1 style={{ padding: '20px', textAlign: 'center' }}>Privacy Policy</h1>
      <p style={{ padding: '20px', textAlign: 'center' }}><strong>Last updated:</strong> December 08, 2024</p>
      ...
      <p>
        ...
        Policy has been created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" rel="noopener noreferrer">Free Privacy Policy Generator</a>.
      </p>
      ...
      <ul>
        ...
        <li><strong>Application:</strong> Refers to iDeals, the software program provided by the Company.</li>
        <li><strong>Company:</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to iDeals.</li>
      ...
      <ul>
        ...
        <li><strong>For business transfers:</strong> In connection with or during negotiations of any merger, sale of Company assets, financing, or acquisition of our business by another company.</li>
        <li><strong>With Affiliates:</strong> Affiliates include our parent company, subsidiaries, joint venture partners or other companies that We control or are under common control with Us.</li>
        <li><strong>With business partners:</strong> To offer certain products, services or promotions.</li>
        <li><strong>With other users:</strong> When you interact in public areas with other users, such information may be publicly distributed.</li>
      ...
      <ul>
        <li>By email: <a href="mailto:b2bmilan@gmail.com">b2bmilan@gmail.com</a></li>
      </ul>
